...
export default class App extends Component {
    ...
    setOperation = operation => {
        if(this.state.current === 0){
            const values = [...this.state.values]
            values[1] = null
            this.setState({operation, current: 1, clearDisplay: true, values})
        }else{
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.buttons}>
                    {/* Como eu botei o () => props.onClick(props.label) no Button, eu não preciso passar cada valor como parâmetro*/}
